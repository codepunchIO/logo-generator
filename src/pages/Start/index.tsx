  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex flex-col mx-auto h-full items-center justify-center">
        <p className=" text-3xl md:text-4xl text-center font-extrabold mb-4 px-2 sm:px-0">Create logo in 3 minutes</p>
        ...
        <div className="flex flex-row bg-grey-400 border rounded-lg justify-center mt-10">
          ...
          <NavLink to={'/generator'}>
            <button
              className="sm:w-48 rounded-r-lg items-center justify-center text-sm sm:text-lg  text-white font-medium text-white h-12 bg-green-500 py-2 px-6 sm:px-8 hover:scale-110 ease-in-out duration-200 leading-6 tracking-wider ease-linear"
